...
namespace {# global alias to the main function:
    if ( ! \function_exists('uri5') ) {
        function uri5 ( $uri = null ) {
            return \uri5\parts( $uri );
        }
    }
}

# define everything else in the uri5 namespace:
namespace uri5 {
    ...
    if ( ! \function_exists( __NAMESPACE__ . '\\parts' ) ) {
        function parts( $uri = null ) {
